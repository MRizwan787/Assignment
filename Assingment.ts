...
console.log(
  `Hello ${name1.toLowerCase()}, How are you today?`
);
console.log(
  `Hello ${name1.toUpperCase()}, How are you today?`
);
...
let names: string[] = ["Friend1", "Friend2", "Friend3", "Friend4"];
...
let names1: string[] = ["Friend1", "Friend2", "Friend3", "Friend4"];
...
const carMakes: string[] = ["Honda", "Toyota", "Ford", "BMW", "Mercedes-Benz"];
...
const guestList1: string[] = ["Albert Einstein", "Leonardo da Vinci", "Marie Curie"];
...
const guestList2: string[] = ["Albert Einstein", "Leonardo da Vinci", "Marie Curie", "Nikola Tesla"];
...
// List of new users
const newUsers: string[] = ['Frank', 'Eve', 'Grace', 'Bob', 'Hannah'];
...
const magicianNames: string[] = ["Harry Houdini", "David Copperfield", "Penn & Teller", "Derren Brown"];
...
// Create an array of magician names
const magicianNames1: string[] = ["Harry Houdini", "David Copperfield", "Penn & Teller", "Derren Brown"];
...
// Create an array of magician names
const magicianNames2: string[] = ["Harry Houdini", "David Copperfield", "Penn & Teller", "Derren Brown"];
...
function createCar(manufacturer: string, model: string, ...details: [string, any][]): Record<string, any> {
    const carInfo: Record<string, any> = { manufacturer, model };
